# Wikidata — navette du 2026-09-02 (4 lignes, un seul Run) : références sur deux recensions *Lectures*
...
> **8 propriétés** par item — aucune déclaration nouvelle).
...
1. Ouvrir le lien du fichier **`deeplink.txt`** : il charge les 4 commandes dans
