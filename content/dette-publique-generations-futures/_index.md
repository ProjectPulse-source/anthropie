...
description: "Oui, au sens précis d'un transfert temporel — mais pas pour les raisons qu'on croit. L'objection « on se la doit à nous-mêmes » (Lerner), sa réfutation, et ce que le débat volume oublie : la répartition. Réponse argument par argument."
date: 2026-07-24
lastmod: 2026-07-24
faq:
  - question: "La dette publique pèse-t-elle vraiment sur les générations futures ?"
    answer: "Oui, au sens précis d'un transfert temporel : ceux qui héritent de la dette n'ont pas contracté l'emprunt, et ils la porteront soit en impôts plus lourds, soit en services publics dégradés, soit les deux. Mais le fardeau n'est pas un remboursement massif à venir — les États refinancent leur dette en permanence. Il est fait des transferts que la dette organise pendant qu'elle roule : charge d'intérêts, arbitrages budgétaires, héritage inégalement réparti."
  - question: "Que signifie l'objection « on se la doit à nous-mêmes » ?"
    answer: "C'est l'argument classique d'Abba Lerner (1948) : si la dette est détenue par les résidents, son remboursement est un transfert interne — des contribuables vers les détenteurs de titres — qui n'appauvrit pas la nation dans son ensemble. L'objection a deux limites : plus de la moitié des titres négociables de l'État sont détenus par des non-résidents, et les intérêts qu'ils perçoivent sortent du pays ; et même un transfert « interne » a des destinataires — il prélève sur tous les contribuables pour rémunérer ceux qui détiennent l'épargne."
  - question: "Les générations futures n'héritent-elles pas aussi des actifs financés par la dette ?"
    answer: "Si — et c'est la meilleure version de l'argument rassurant : une dette qui finance des infrastructures, de l'éducation ou la transition transmet un capital en même temps qu'une charge. La question opératoire est donc : quelle part de l'emprunt finance de l'investissement transmissible, et quelle part finance du fonctionnement courant ? Quand la dette roule pour payer les dépenses du présent, l'héritage se réduit à la charge."
  - question: "Quel est le lien avec le cadre anthropique ?"
    answer: "La dette publique est l'exemple canonique du transfert temporel : un coût présent déplacé vers des payeurs futurs qui n'ont pas voix au chapitre. Le cadre ajoute la dimension sociale : à l'intérieur de chaque génération future, la charge se répartira inégalement — vers les groupes captifs, non mobiles fiscalement ou géographiquement. L'analyse est formalisée dans AWP-03 (DOI 10.5281/zenodo.19268769) et déployée dans le livre Dette Publique : Qui paie vraiment ? (2025)."
---
...
**Où l'analyse est-elle formalisée&nbsp;?** Dans le working paper [AWP-03 — *Dette publique et anthropie*](/awp/awp-03/) (DOI&nbsp;: 10.5281/zenodo.19268769, PDF en accès libre) et dans le livre [*Dette Publique&nbsp;: Qui paie vraiment&nbsp;?*](/livres/dette-publique-qui-paie-vraiment/) (2025, 224&nbsp;p.), qui consacre ses scénarios 2025-2035 à la trajectoire de ces transferts.

## Pour aller plus loin

- [Qui paie vraiment la dette publique&nbsp;?](/qui-paie-la-dette-publique/) — la page maîtresse&nbsp;: tous les mécanismes de transfert.
