...
faq:
  ...
  - question: "Que signifie l'objection « on se la doit à nous-mêmes » ?"
    answer: "C'est l'argument classique d'Abba Lerner (1948) : si la dette est détenue par les résidents, son remboursement est un transfert interne — des contribuables vers les détenteurs de titres — qui n'appauvrit pas la nation dans son ensemble. L'objection a deux limites : plus de la moitié de la dette de l'État français est détenue par des créanciers étrangers, dont les intérêts quittent le pays ; et même un transfert « interne » a des destinataires — il prélève sur tous les contribuables pour rémunérer ceux qui détiennent l'épargne."
