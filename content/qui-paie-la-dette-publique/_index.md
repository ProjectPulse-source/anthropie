...
faq:
  ...
  - question: "La dette publique est-elle un fardeau pour les générations futures ?"
    answer: "Oui, au sens précis d'un transfert temporel : les générations qui héritent de la dette n'ont pas contracté l'emprunt, et elles la porteront soit en impôts plus lourds, soit en services publics dégradés, soit les deux. C'est le mécanisme central analysé dans AWP-03 et dans le livre Dette Publique : Qui paie vraiment ?"
  - question: "Qui détient la dette publique française ?"
    answer: "Selon les données rassemblées dans le livre (2025) : la dette de l'État (82 % du total) est détenue pour plus de moitié par des créanciers étrangers ; la dette des collectivités locales reste très majoritairement française ; la dette sociale a un profil mixte. Mais détenir n'est pas payer : la question du détenteur (à qui vont les intérêts) est distincte de celle du payeur (qui subit le prélèvement ou le renoncement)."
  - question: "Faut-il rembourser la dette publique ?"
    answer: "La question du remboursement intégral est largement théorique — les États refinancent leur dette en permanence. La question opératoire est celle des transferts que la dette organise pendant qu'elle roule : qui paie les intérêts, qui subit les arbitrages budgétaires, qui hérite. C'est à cette question que répond le cadre anthropique."
---
...
Appliquée aux finances publiques, cette hypothèse est formalisée dans le working paper [AWP-03 — *Dette publique et anthropie&nbsp;: qui paie vraiment le désordre&nbsp;?*](/awp/awp-03/) (DOI&nbsp;: 10.5281/zenodo.19268769, PDF en accès libre) et déployée dans le livre [*Dette Publique&nbsp;: Qui paie vraiment&nbsp;?*](/livres/dette-publique-qui-paie-vraiment/) (2025, 224 p.), qui répond chapitre par chapitre — mécanique du transfert, créanciers invisibles, scénarios 2025-2035.
