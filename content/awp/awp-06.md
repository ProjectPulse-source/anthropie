...
keywords_en: ["anthropy", "data centers", "generative AI", "derisking", "digital infrastructures"]
faq:
  - question: "Qu'apporte le cadre anthropique au numérique ?"
    answer: "Le cadre anthropique unifie matérialité, opacité et empreinte environnementale comme variantes d'un même mécanisme : le service numérique n'a pas allégé la matière, il l'a déplacée vers d'autres lieux, d'autres temps, d'autres groupes sociaux."
  - question: "Qu'est-ce que les registres de coûts couplés ?"
    answer: "Une grille testable des quatre registres — énergie, matière, territoire, attention — qui montre comment l'infrastructure numérique déplace simultanément le désordre selon plusieurs axes irréductibles. C'est l'apport central d'AWP-06."
  - question: "Comment le coût devient-il dette technologique ?"
    answer: "Par engagement, garantie et irréversibilisation. Le derisking (Daniela Gabor) couple un mécanisme contemporain à une formation institutionnelle longue — l'État de marché — qui transforme un coût présent en dette future inéluctable."
pdf_url: "https://zenodo.org/records/20025421/files/AWP-06_infrastructures_numeriques.pdf"
language: "fr"
