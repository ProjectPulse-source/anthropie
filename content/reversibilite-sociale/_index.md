---
title: "Qu'est-ce que la réversibilité sociale ?"
...
faq:
  ...
  - question: "Quelle est la différence entre la réversibilité sociale et le droit à l'erreur de la loi ESSOC ?"
    answer: "Le droit à l'erreur de la loi ESSOC (2018) est un dispositif administratif : un usager de bonne foi qui se trompe dans une déclaration peut rectifier sans sanction. La réversibilité sociale est un concept d'analyse : elle mesure ce que coûte réellement un échec — professionnel, entrepreneurial, financier — selon la capacité de repli de la personne, la trace que les institutions gardent de l'échec et les conditions de réadmission. L'un est une règle fiscale, l'autre une dimension de l'inégalité."
  - question: "De quoi dépend la capacité à rebondir après un échec ?"
    answer: "De trois composantes qui se combinent : la capacité de repli (tenir l'intervalle après la chute — épargne, entourage, filet institutionnel), le tarif institutionnel de l'échec (ce que coûte, en droit et en pratique, un échec inscrit quelque part) et l'environnement d'accès (les conditions de réadmission). L'hypothèse centrale d'AWP-08 est leur complémentarité : un repli solide ne protège pas si la trace de l'échec verrouille la réadmission, et une réadmission ouverte ne protège personne qui ne peut pas tenir l'intervalle."
  - question: "Pourquoi la seconde chance n'est-elle pas la même pour tous ?"
    answer: "Parce que le tarif de l'échec est stratifié : deux personnes voisines en revenu peuvent avoir des avenirs très différents selon que leur erreur s'efface ou s'inscrit durablement dans une mémoire institutionnelle — fichier d'incidents de paiement, historique de défaut, signalement. Cette inégalité-là n'apparaît ni dans les statistiques de revenu, ni dans celles de mobilité."
  - question: "La réversibilité sociale se mesure-t-elle ?"
...
Le sens que construit la réversibilité sociale est plus large&nbsp;: un droit à l'erreur *sociologique*. La question n'est plus «&nbsp;puis-je corriger ma déclaration&nbsp;?&nbsp;» mais «&nbsp;que coûte réellement un échec — professionnel, entrepreneurial, financier — et ce coût est-il le même pour tous&nbsp;?&nbsp;». La réponse d'[AWP-08](/awp/awp-08/) est que ce coût est **stratifié**&nbsp;: le tarif de l'échec varie selon la position sociale, et cette variation est une inégalité à part entière, rarement lue comme telle.
...
C'est le lien avec le cadre général de l'[anthropie](/quest-ce-que-lanthropie/)&nbsp;: le coût de l'échec ne disparaît pas, il est déplacé et réparti — inégalement. [AWP-01](/awp/awp-01/) pose l'hypothèse du déplacement du désordre&nbsp;; [AWP-07](/awp/awp-07/) en formalise la boucle&nbsp;; [AWP-08](/awp/awp-08/) en donne la contrepartie micro-institutionnelle&nbsp;: le tarif stratifié de l'échec est un mécanisme de distribution du désordre social.
